...
,
  ...
  /* ===================== Theocritus, Idyll 11.19–81 ===================== */

  { id:"theoc11-19-81:s1:q1", readingId:"theoc11-19-81", seg:1, type:"syntax",
    prompt:"λευκοτέρα πακτᾶς ποτιδεῖν, ἁπαλωτέρα ἀρνός, μόσχω γαυροτέρα, φιαρωτέρα ὄμφακος ὠμᾶς. Account for the case of πακτᾶς, ἀρνός, μόσχω and ὄμφακος, and parse ποτιδεῖν.",
    answer:"All four are GENITIVES OF COMPARISON with the four comparative adjectives — Greek can express the second term of a comparison by a bare genitive instead of ἤ + the same case. ποτιδεῖν is an epexegetic (explanatory) aorist infinitive limiting λευκοτέρα: 'whiter TO LOOK AT'. Doric ποτι- for προσ-.",
    why:"Two rules, both with wide reach. First: any comparative should make you look for either ἤ or a stray genitive, and here there are four of each in two lines. Note that the order alternates — adjective before genitive, then genitive before adjective (μόσχω γαυροτέρα) — so you cannot rely on position, only on the case. Second: adjectives like ῥᾴδιος, χαλεπός, δεινός, καλός and here λευκός take an infinitive telling you in what respect they hold; you met the same construction at line 4, εὑρεῖν δ᾽ οὐ ῥᾴδιόν ἐστι. The four comparisons are also a set-piece worth recognizing as such: curd, lamb, calf and unripe grape are all farmyard, which is the joke — the Cyclops praises a sea-nymph entirely in dairy terms." },

  { id:"theoc11-19-81:s2:q1", readingId:"theoc11-19-81", seg:2, type:"syntax",
    prompt:"φοιτῇς δ᾽ αὖθ᾽ οὕτως ὅκκα γλυκὺς ὕπνος ἔχῃ με. Resolve ὅκκα, justify the mood of ἔχῃ, and say what αὖθ᾽ means here.",
    answer:"ὅκκα is Doric ὅκα (= ὅτε) fused with κα (= ἄν), so ὅταν, 'whenever' — and that κα is exactly why ἔχῃ is subjunctive rather than indicative. Dover: αὖθ᾽ is αὖθι here in the sense αὐτίκα, 'at once', not 'again' and not 'here'; οὕτως is 'without more ado'.",
    why:"The Doric κα = ἄν is the key that unlocks a whole family: ὅκκα = ὅταν (here and at 23), αἴ κα = ἐάν (61), ἐπεί κα = ἐπειδάν (78), and κα alone with the optative gives the potential (49, 74). Whenever you see a κ-particle welded to a temporal or conditional word, expect an indefinite construction and a subjunctive. The vocabulary point is worth as much: αὖθι and αὖθις look alike and mean different things, and reading 'again' here would blunt the complaint, which is entirely about TIMING — she turns up the instant he falls asleep. Lines 22 and 23 are built as near-mirror images, so having parsed one you have parsed both." },

  { id:"theoc11-19-81:s3:q1", readingId:"theoc11-19-81", seg:3, type:"syntax",
    prompt:"οἴχῃ δ᾽ εὐθὺς ἰοῖσ᾽ ὅκκα γλυκὺς ὕπνος ἀνῇ με. Parse οἴχῃ and ἰοῖσ᾽, and explain how they work together.",
    answer:"οἴχῃ is present middle indicative 2nd singular of οἴχομαι, present in form but PERFECT in sense: 'you are gone'. ἰοῖσα is the present participle of εἶμι (Doric -οισα for -ουσα), a supplementary participle with it — οἴχομαι + participle is the standard idiom, 'I am off and away'.",
    why:"οἴχομαι belongs with a small group of presents that mean a completed state (compare ἥκω 'I have come'), so translating it 'you are going' loses the point: she is already gone before he is properly awake. And the pairing of οἴχομαι with a participle of motion is fixed idiom — the participle carries the manner, the verb the fact of absence. The Doric feminine participle in -οισα is now familiar from γελάοισα and ἔχοισα in Idyll 1 and recurs at 57 (ἔχοισαν), 63 (ἐξενθοῖσα) and 75 (παρεοῖσαν) here. Note also ἀνῇ, the athematic aorist subjunctive of ἀνίημι: the compounds of ἵημι contract to a bare vowel plus ending and have to be recognized rather than derived." },

  { id:"theoc11-19-81:s5:q1", readingId:"theoc11-19-81", seg:5, type:"syntax",
    prompt:"ἠράσθην μὲν ἔγωγε τεοῦς, κόρα. Parse ἠράσθην and account for τεοῦς.",
    answer:"ἠράσθην is aorist PASSIVE in form but middle in meaning, 1st singular of ἔραμαι, and INGRESSIVE in aspect: not 'I loved' but 'I fell in love'. τεοῦς is the Doric genitive of σύ (= σοῦ), governed by it — verbs of loving and desiring take the genitive.",
    why:"Three things at once. Aorist passives in -θην that are middle in sense form a large class (ἠράσθην, ἐβουλήθην, ἐδυνάθην at 59 here) — the -θη- tells you the form, not the voice, so check the dictionary before assuming 'I was loved'. The ingressive aorist is the standard way Greek marks entry into a state: the aorist of a stative verb means 'came to be', which is why ἐβασίλευσα is 'I became king'. And the case: ἔραμαι + genitive is the same rule as at 8 and 10 of this poem and τίνος … ἔρασαι at Idyll 1.78. Learn the Doric pronoun paradigm as a block while you are here — nom. τύ, acc. τυ or τίν, gen. τεοῦς or τεῦς, dat. τίν — because the poem uses every one of them and the case is often the only thing that tells you the construction." },

  { id:"theoc11-19-81:s7:q1", readingId:"theoc11-19-81", seg:7, type:"syntax",
    prompt:"παύσασθαι δ᾽ ἐσιδών τυ καὶ ὕστερον οὐδ᾽ ἔτι πα νῦν ἐκ τήνω δύναμαι. Where is the main verb, what governs παύσασθαι, and what is left unsaid?",
    answer:"δύναμαι at the very end is the main verb, and παύσασθαι at the very beginning is its complementary infinitive — they stand eleven words apart. Dover: the object of παύσασθαι is deliberately suppressed, 'I cannot stop ⟨loving you⟩'.",
    why:"Two habits. First, hold an unattached infinitive open: Greek can front a complementary infinitive for emphasis and leave its governing verb to the end of the sentence, and if you try to attach παύσασθαι to ἐσιδών you will get nowhere. Second, the suppression is a rhetorical device, not a gap in your understanding — the same tactful breaking-off as Idyll 1.105, where Daphnis leaves the infinitive after λέγεται unspoken. When a Greek sentence seems to be missing a word in a passage about sex or love, ask whether the omission is the point. Note also ἐκ τήνω, 'from that moment' (Doric τῆνος = ἐκεῖνος in the Doric genitive -ω), and the pile-up οὐδ᾽ … πα, matching οὔ τι πα at Idyll 1.63." },

  { id:"theoc11-19-81:s8:q1", readingId:"theoc11-19-81", seg:8, type:"syntax",
    prompt:"τὶν δ᾽ οὐ μέλει, οὐ μὰ Δί᾽ οὐδέν. What case is τίν here, and how do you know?",
    answer:"DATIVE. μέλει is impersonal — 'it is a care to someone' — so the person concerned goes in the dative. That matters because in this poem τίν more often stands for the accusative σέ (5, 39, 55, 68); only the governing verb tells you which case you have.",
    why:"This is the single most useful thing to know about Doric pronouns: τίν is not one form but two, dative σοί and accusative σέ, distinguished by nothing in the word itself. So the procedure is always to find the governing word first. Here μέλει demands a dative; at 68 (ποτὶ τίν) the preposition demands an accusative. The impersonal construction itself is worth having ready — μέλει μοι τούτου, 'I care about this', with dative of person and genitive of thing — and it appeared in the cup-description at Idyll 1.53. Dover adds that the doubled negative reinforced by an oath (οὐ … οὐ μὰ Δία … οὐδέν) has a flavour of Comedy: it is the register of everyday exasperation, not of epic." },

  { id:"theoc11-19-81:s9:q1", readingId:"theoc11-19-81", seg:9, type:"syntax",
    prompt:"γινώσκω, χαρίεσσα κόρα, τίνος οὕνεκα φεύγεις· οὕνεκά μοι λασία μὲν ὀφρύς … The word οὕνεκα appears twice in two lines. Is it doing the same job?",
    answer:"No. In 30 it is the preposition-like 'on account of', taking the genitive τίνος and making an indirect question after γινώσκω — 'why you run away'. In 31 the same word is a causal CONJUNCTION, 'because', introducing the answer.",
    why:"οὕνεκα is a fusion of οὗ ἕνεκα, and it kept both halves of its history: it can govern a genitive like a preposition, or introduce a clause like ὅτι. The repetition here is deliberate rhetoric — question and answer pinned together by the same word at the head of consecutive lines — and it is a good test of whether you are reading the syntax or just the vocabulary. The general lesson is that a Greek word's part of speech is often decided by what follows it, exactly as with τοί (article at Idyll 1.80, relative at 1.118) and τίν above. Note too that the indirect question after γινώσκω keeps the indicative φεύγεις rather than shifting to the optative: the main verb is primary (present), so no shift is available — contrast πάθοι at Idyll 1.81, where the main verb was past." },

  { id:"theoc11-19-81:s10:q1", readingId:"theoc11-19-81", seg:10, type:"syntax",
    prompt:"οὕνεκά μοι λασία μὲν ὀφρὺς ἐπὶ παντὶ μετώπῳ ἐξ ὠτὸς τέταται ποτὶ θώτερον. Parse τέταται and resolve θώτερον. What is μοι doing?",
    answer:"τέταται is perfect middle/passive 3rd singular of τείνω, a PERFECT OF STATE and so present in force: 'lies stretched'. θώτερον is crasis of τὸ ἕτερον, with the τ aspirated to θ by the rough breathing — supply οὖς, 'to the other ear'. μοι is a possessive dative, 'my eyebrow'.",
    why:"The perfect of state is one of the most useful categories in Greek: πέφυκα 'I am by nature' (line 1), ἕστηκα 'I stand', οἶδα 'I know', ἐκπεπότασαι 'you are flown off' (72) and τέταται here all describe a present condition resulting from a past act, and translating them as past tenses produces nonsense. Crasis with the article is by now a running theme — collect θώτερον with τωὔλιον (12), τὥντρῳ (44), κἠκ (35), κἠμαυτόν (39), κἠγών (71, 79) — and remember the two tells: a coronis, or a consonant aspirated from τ/κ to θ/χ. The possessive dative (μοι, and again at 51) is the ordinary Greek alternative to a possessive adjective, and much commoner in verse." },

  { id:"theoc11-19-81:s12:q1", readingId:"theoc11-19-81", seg:12, type:"syntax",
    prompt:"ἀλλ᾽ οὗτος τοιοῦτος ἐὼν βοτὰ χίλια βόσκω. Parse ἐών and say what force the participle has.",
    answer:"ἐών is the uncontracted epic/Doric present participle of εἰμί (= ὤν), nominative singular masculine, agreeing with the subject of βόσκω. It is CONCESSIVE: 'though I am like this'. Dover analyses the phrase as 'being this person here, the sort of person that I am'.",
    why:"A circumstantial participle carries no marker of its own force — temporal, causal, concessive, conditional — and you have to get that from context. Here the ἀλλά at the head of the line does the work: he has just catalogued his own ugliness, so 'being such' must be a concession, and English needs 'though'. Compare ὁρεῦσα at 69, where the same bare participle is concessive again ('although she sees me'), and ἐόντα at line 5, where it was causal ('since you are a doctor'). Get into the habit of asking which of the five forces fits before you translate. The uncontracted ἐών is pure recognition — Attic contracts it to ὤν — and note that οὗτος used of oneself is deictic and slightly comic, 'this specimen here'." },

  { id:"theoc11-19-81:s14:q1", readingId:"theoc11-19-81", seg:14, type:"syntax",
    prompt:"οὐ χειμῶνος ἄκρω· ταρσοὶ δ᾽ ὑπεραχθέες αἰεί. What does χειμῶνος ἄκρω mean, and why does the phrase matter?",
    answer:"'At the END of winter', not 'in the depth of winter'. ἄκρω is the Doric genitive of the substantivized ἄκρον 'tip, extremity', with χειμῶνος a possessive genitive depending on it.",
    why:"Dover argues the point from sense and parallel, and it is the difference between a trivial boast and a real one: there SHOULD be plenty of cheese in midwinter, but one expects a shortage by the time winter ends — so 'even at winter's end' is the claim worth making. He compares Aratus, where ἀκρόθι νυκτός must mean 'just before dawn' rather than 'at dead of night'. The wider lesson is that ἄκρος means 'at the outer edge of' whatever it governs, and which edge is a matter of what the thing is: ἄκρα χείρ is the fingertips, ἄκρον ὄρος the summit. Note also the negative sequence οὔτε … οὔτε … οὐ running from 36 into this line — Dover flags it as a recognized pattern, so do not expect a third οὔτε." },

  { id:"theoc11-19-81:s15:q1", readingId:"theoc11-19-81", seg:15, type:"morphology",
    prompt:"συρίσδεν δ᾽ ὡς οὔτις ἐπίσταμαι ὧδε Κυκλώπων. Parse συρίσδεν, and account for the case of Κυκλώπων.",
    answer:"συρίσδεν is a present active INFINITIVE — Doric on two counts, -σδ- for -ζ- and the infinitive ending -εν for -ειν. It is complementary with ἐπίσταμαι, which means 'know how to' when it takes an infinitive. Κυκλώπων is a partitive genitive with οὔτις, 'none of the Cyclopes'.",
    why:"The Doric infinitive in -εν is easy to mistake for a 3rd plural or a neuter noun, and it recurs at 77 (συμπαίσδεν). Pair it with the -σδ- rule, which by now you have met in μελίσδεται, φράσδη, ποτίσδων, ὄσδει, γενειάσδων, and here again in σφύσδειν (71) and μουσίσδων (81): reading -σδ- as -ζ- turns strange words into familiar ones. The construction with ἐπίσταμαι is worth fixing too — with an infinitive it is 'know how to', with a participle 'know that', a distinction it shares with οἶδα and μανθάνω. And note οὔτις: for anyone who knows the Odyssey the word is loaded, since Οὖτις is the name Odysseus will give this same Cyclops. Theocritus drops it in without comment." },

  { id:"theoc11-19-81:s16:q1", readingId:"theoc11-19-81", seg:16, type:"syntax",
    prompt:"πολλάκι νυκτὸς ἀωρί … ἅδιον ἐν τὥντρῳ … τὰν νύκτα διαξεῖς (44). The same noun appears as νυκτός here and τὰν νύκτα at 44. What is the difference?",
    answer:"νυκτός is a GENITIVE OF TIME WITHIN WHICH — 'at some point during the night'. τὰν νύκτα at 44 (and 77) is an ACCUSATIVE OF DURATION — 'right through the night, for the night's whole length'. Neither takes a preposition.",
    why:"Greek divides the work of time-expressions between three cases and needs no preposition for any of them: genitive for the period within which something falls, accusative for how long it lasts, dative for the point at which it happens. Getting them apart is worth real marks, and this poem obligingly puts two of them a few lines apart. The same distinction runs through line 58, where θέρεος is a bare genitive of time ('in summer') and ἐν χειμῶνι uses the preposition instead — showing that the bare genitive and ἐν + dative are alternatives for the same job. Once you have the pattern, ἆμαρ ἐπ᾽ ἆμαρ at 69 stands out as the odd one, which is exactly what Dover says about it: the expression defies precise analysis though its meaning is clear." },

  { id:"theoc11-19-81:s17:q1", readingId:"theoc11-19-81", seg:17, type:"morphology",
    prompt:"ἀλλ᾽ ἀφίκευσο ποθ᾽ ἁμέ, καὶ ἑξεῖς οὐδὲν ἔλασσον. Parse ἀφίκευσο and ἑξεῖς, and say what ἁμέ is.",
    answer:"ἀφίκευσο is an aorist middle IMPERATIVE 2nd singular of ἀφικνέομαι — a thematic verb given the athematic ending -σο. ἑξεῖς is the Doric contracted future of ἔχω (= Attic ἕξεις). ἁμέ is Doric for ἡμᾶς, poetic plural for singular, 'me'.",
    why:"Dover explains the imperative: the ancient commentator knew of other thematic imperatives in -σο formed by analogy with athematic ones like μέμνησο, and regarded them as Syracusan. You will not derive it from a paradigm, so recognize it — the ἀλλά plus a second-person form is enough to tell you an imperative is wanted. ἑξεῖς joins the Doric contracted-type futures that run through both poems: φυλαξεῖς, λυγιξεῖν, ᾀσῶ, δοκησεῖς, σκιρτασεῖτε in Idyll 1, and διαξεῖς (44), μαθεῦμαι (60), φασῶ (70), εὑρησεῖς (76) here. The idiom οὐδὲν ἔλασσον ἔχειν is 'be no worse off' — Dover glosses 'for the change' — and it is the negative of πλέον ἔχειν 'have an advantage'." },

  { id:"theoc11-19-81:s18:q1", readingId:"theoc11-19-81", seg:18, type:"syntax",
    prompt:"τὰν γλαυκὰν δὲ θάλασσαν ἔα ποτὶ χέρσον ὀρεχθεῖν. Is θάλασσαν the object of ἔα?",
    answer:"No. ἐάω takes an ACCUSATIVE AND INFINITIVE, so θάλασσαν is the subject accusative of ὀρεχθεῖν, and the whole 'the sea to roar' is what he is telling her to allow: 'let the sea go on roaring against the shore'.",
    why:"Verbs of permitting, causing, compelling and preventing (ἐάω, κελεύω, ἀναγκάζω, κωλύω) all take acc. + inf., and the accusative belongs to the infinitive rather than to the main verb — misassigning it turns 'let the sea roar' into the nonsense 'leave the sea alone'. The test is simply whether an infinitive follows. Note also the word-order: δέ is postpositive and has been dropped inside the article-adjective-noun group τὰν γλαυκὰν … θάλασσαν, which is normal and should not make you break the phrase up. ὀρεχθέω is a rare Homeric verb of deep sound; the sense is that she should let the sea get on with being the sea while she comes ashore." },

  { id:"theoc11-19-81:s20:q1", readingId:"theoc11-19-81", seg:20, type:"morphology",
    prompt:"ἐντὶ δάφναι τηνεί, ἐντὶ ῥαδιναὶ κυπάρισσοι, ἔστι μέλας κισσός. Parse ἐντί, and explain why the verb changes to ἔστι halfway through.",
    answer:"ἐντί is the DORIC 3rd PLURAL of εἰμί = Attic εἰσί, 'there are'. It changes to the singular ἔστι because the subjects that follow (κισσός, ἄμπελος, ὕδωρ) are singular — the anaphora continues, the number simply adjusts.",
    why:"ἐντί is one of the forms most likely to stop you dead, because it looks like a preposition plus an enclitic (ἐν + τι) and has no visible relation to εἰσί. Learn it as a lexical item; it returns at 51 in the sense 'I have', with a dative of possession (ἐντὶ … μοι, 'there are to me'). The ending is the familiar Doric -ντι that you met in γελᾶντι and βομβεῦντι, and which appears in the athematic singular as -τι (προΐητι, 48). Structurally the passage is a locus amoenus — the standard 'pleasant place' catalogue of bucolic poetry — being deployed as an estate agent's inventory, and the repeated verb at the head of each item is what holds the list together." },

  { id:"theoc11-19-81:s21:q1", readingId:"theoc11-19-81", seg:21, type:"syntax",
    prompt:"ἔστι ψυχρὸν ὕδωρ, τό μοι ἁ πολυδένδρεος Αἴτνα λευκᾶς ἐκ χιόνος ποτὸν ἀμβρόσιον προΐητι. Identify τό and ποτόν, and parse προΐητι.",
    answer:"τό is the article used as a RELATIVE pronoun, object of προΐητι, with ὕδωρ as its antecedent. ποτὸν ἀμβρόσιον is in predicative APPOSITION to it — 'which she sends forth … as an ambrosial drink'. προΐητι is Doric for προΐησι, present active 3rd singular of προΐημι.",
    why:"The article-as-relative is standard in this poetry and you have met it at Idyll 1.126 and at 11.16; the tell is that a finite verb follows and there is no noun for the 'article' to lean on. Predicative apposition is the subtler point: a second accusative standing beside the object and describing what it counts as, with no ὡς and no εἶναι — the same construction as βέλεμνον at line 16, which Dover explicitly makes predicative. If you try to read ποτόν as a second object you will find προΐητι already has one. The verb itself is a compound of ἵημι, so the stem is a bare -ι-, and the Doric -τι for -σι matches the plural -ντι of ἐντί two lines earlier." },

  { id:"theoc11-19-81:s22:q1", readingId:"theoc11-19-81", seg:22, type:"syntax",
    prompt:"τίς κα τῶνδε θάλασσαν ἔχειν καὶ κύμαθ᾽ ἕλοιτο; Parse ἕλοιτο, and account for τῶνδε.",
    answer:"ἕλοιτο is aorist MIDDLE optative 3rd singular of αἱρέω; with κα (= ἄν) it is a POTENTIAL optative, 'who would choose?'. The middle of αἱρέω means 'choose', the active 'take'. τῶνδε is a genitive of the thing rejected — Dover: 'in preference to this'.",
    why:"Two points that repay attention. The voice of αἱρέω changes its dictionary meaning outright, which is true of a whole set of verbs (ἄρχω 'rule' / ἄρχομαι 'begin', γαμέω of the man / γαμέομαι of the woman) — always check voice before meaning. And the genitive is irregular enough that Dover has to explain it: αἱρεῖσθαι does not normally take a genitive of the alternative, but it has been assimilated here to the construction of προτιθέναι and προτιμᾶν, 'prefer X to Y'. So it works as a genitive of comparison. On the mood: an optative with ἄν/κα is potential ('would'), without it a wish ('may') — compare the string of wish-optatives at 63–65 in this same poem, none of which has a κα near it." },

  { id:"theoc11-19-81:s23:q1", readingId:"theoc11-19-81", seg:23, type:"syntax",
    prompt:"αἰ δέ τοι αὐτὸς ἐγὼν δοκέω λασιώτερος ἦμεν. Parse ἦμεν, explain why λασιώτερος is nominative, and say what the comparative means.",
    answer:"ἦμεν is the DORIC INFINITIVE of εἰμί = Attic εἶναι. δοκέω is used personally — 'I seem to be' — so its complement λασιώτερος agrees with the subject in the nominative. Dover: the comparative is used absolutely, 'more hairy than is right', i.e. TOO hairy.",
    why:"ἦμεν looks exactly like a 1st plural imperfect, so the construction has to decide it: δοκέω needs an infinitive, and there is no plural subject anywhere. It returns at 79 in the same job. The personal construction of δοκέω is worth contrasting with the impersonal δοκεῖ μοι of line 2 — personal gives a nominative complement, impersonal an accusative-and-infinitive, and the two are easy to confuse. The absolute comparative is the third point and a common idiom: a comparative with no expressed standard often means 'rather too', as with νεώτερος 'rather young', θερμότερος 'too hot'. Dover adds the cultural note that, to judge from vase-painting, a hairy chest was not admired — so the Cyclops is conceding a real objection." },

  { id:"theoc11-19-81:s24:q1", readingId:"theoc11-19-81", seg:24, type:"syntax",
    prompt:"ἐντὶ δρυὸς ξύλα μοι καὶ ὑπὸ σποδῶ ἀκάματον πῦρ. What is μοι doing, and what case is σποδῶ?",
    answer:"μοι is a DATIVE OF POSSESSION with the verb 'to be' — ἐντὶ … μοι = 'there are to me' = 'I have'. σποδῶ is the Doric genitive (= σποδοῦ) after ὑπό, 'under the ash'.",
    why:"The dative of possession with εἰμί is one of the two standard Greek ways of saying 'have', and in verse it is commoner than ἔχω. Recognizing it turns an apparently subjectless 'there are logs' into 'I have logs', which is the whole point of the line — he is still listing his assets. On σποδῶ: Dover argues for the genitive against the variant dative σποδῷ, comparing Odyssey 9.375, where Odysseus heats the stake ὑπὸ σποδοῦ πολλῆς — under a deep bed of ash. That parallel is not innocent: it is the line in which this very Cyclops gets his one eye put out, and Theocritus has him boasting about the fire that will do it. Note that ὑπό is a three-case preposition, and that + genitive it is either 'under' (local) or 'by' (agent) — one line later, at 52, it is the agent with a passive." },

  { id:"theoc11-19-81:s25:q1", readingId:"theoc11-19-81", seg:25, type:"syntax",
    prompt:"καιόμενος δ᾽ ὑπὸ τεῦς καὶ τὰν ψυχὰν ἀνεχοίμαν καὶ τὸν ἕν᾽ ὀφθαλμόν. Parse καιόμενος and ἀνεχοίμαν, and account for τὰν ψυχάν and τὸν ὀφθαλμόν.",
    answer:"καιόμενος is present PASSIVE participle with ὑπὸ τεῦς as its agent, 'being burnt by you', and it is supplementary with ἀνεχοίμαν — ἀνέχομαι takes a participle for what one endures. ἀνεχοίμαν is a potential optative (Doric -μαν for -μην). ψυχάν and ὀφθαλμόν are ACCUSATIVES OF RESPECT with καιόμενος: 'burnt as to my soul and my one eye'.",
    why:"The accusative of respect is the recurring construction of this quiz — τάκεται ὀφθαλμώς at Idyll 1.88 and 91, and again τὰς φρένας ἐκπεπότασαι at 72 here. Whenever a verb that cannot take an object has an accusative sitting beside it, try 'in respect of'. ἀνέχομαι + participle belongs with the family of verbs (ἀνέχομαι, παύομαι, ἄρχομαι, χαίρω, φαίνομαι) that complete themselves with a participle rather than an infinitive; getting the pattern wrong will make you look for a governing verb that is not there. On the optative: strictly it wants an ἄν, and verse can drop the particle — the κα of 49 is still colouring the sentence. The line is also the poem's grimmest joke, since the one eye is exactly what he is about to lose." },

  { id:"theoc11-19-81:s27:q1", readingId:"theoc11-19-81", seg:27, type:"syntax",
    prompt:"ὤμοι ὅτ᾽ οὐκ ἔτεκέν μ᾽ ἁ μάτηρ βράγχι᾽ ἔχοντα, ὡς κατέδυν ποτὶ τὶν καὶ τὰν χέρα τεῦς ἐφίλησα. Why does the ὡς-clause have indicative verbs, and what does κατέδυν mean?",
    answer:"Because the purpose was never realized. Greek puts a final clause into a past INDICATIVE when its purpose is unattainable — his mother did not give him gills, so the diving and the kissing never happened: 'so that I might have dived down to you'. κατέδυν is an intransitive root aorist, 'I sank, dived down'.",
    why:"This is the construction to set beside the two ordinary purpose clauses in the same poem: ὡς εἰδῶ at 62 with the subjunctive (a real plan) and ὡς ἀνιαθῇ at 71 with the subjunctive again. When the same conjunction takes a past indicative instead, the purpose is being marked as impossible — mood is carrying information that English has to render with 'would have'. On the verb: δύω is transitive in the sigmatic aorist (ἔδυσα, 'I made to sink') but intransitive in the root aorist ἔδυν, exactly the split you met with ἵστημι at Idyll 1.152 (ἀναστῇ) and with φύω. And note ὅτ᾽: Dover says it is ὅτι here, 'alas THAT', on the strength of the certain elision of ὅτι at 79." },

  { id:"theoc11-19-81:s28:q1", readingId:"theoc11-19-81", seg:28, type:"syntax",
    prompt:"αἰ μὴ τὸ στόμα λῇς, ἔφερον δέ τοι ἢ κρίνα λευκά. Why μή rather than οὐ, and what is λῇς?",
    answer:"μή because the clause is CONDITIONAL — a protasis takes μή, not οὐ, and the negative alone is enough to tell you what kind of clause you are in. λῇς is 2nd singular of λῶ, the Doric verb for 'wish, be willing', which has no Attic counterpart in form: λῶ, λῇς, λῇ.",
    why:"The distribution of the two negatives is a genuinely useful diagnostic: οὐ negates statements and indicative fact, μή negates wishes, commands, conditions, purposes and generalizations. Meeting μή where you expected οὐ should make you ask what construction you are in — and here it confirms αἰ as 'if' rather than anything else. λῶ has to be learnt as vocabulary; it appeared at Idyll 1.12 and its forms look like nothing else. The line also shows Greek economy: the verb of kissing is not repeated, but simply carried over from ἐφίλησα in the line before, so τὸ στόμα has no expressed verb of its own. When an accusative is stranded, look back for a verb to borrow." },

  { id:"theoc11-19-81:s29:q1", readingId:"theoc11-19-81", seg:29, type:"syntax",
    prompt:"ἀλλὰ τὰ μὲν θέρεος, τὰ δὲ γίνεται ἐν χειμῶνι. What are τὰ μέν and τὰ δέ, and why is γίνεται singular?",
    answer:"τὰ μέν … τὰ δέ is the article in its old DEMONSTRATIVE use, 'the one lot … the other lot' — there is no noun for it to modify. γίνεται is singular because its subjects are neuter plural, and a neuter plural subject regularly takes a singular verb.",
    why:"Two rules you now have several times over. The article as pronoun runs right through this quiz — τώς 'them' at Idyll 1.92, τάν 'her' at 1.100, ὁ δέ 'but he' at 11.13, and here τὰ μέν … τὰ δέ; if there is no noun nearby, it is not an article. And the neuter plural with a singular verb has appeared at Idyll 1.134 (πάντα … γένοιτο) and 1.139 (λίνα πάντα λελοίπει). The line also puts two time-expressions side by side, the bare genitive θέρεος and ἐν + dative χειμῶνι, showing they are alternatives for the same job. Dover's reading of the tone is worth having: he is not correcting himself — he never claimed he would bring both at once — but pedantically explaining to an imaginary objector who is probably Galateia, better acquainted with the sea than with the land." },

  { id:"theoc11-19-81:s30:q1", readingId:"theoc11-19-81", seg:30, type:"syntax",
    prompt:"ὥστ᾽ οὔ κά τοι ταῦτα φέρειν ἅμα πάντ᾽ ἐδυνάθην. What kind of ὥστε clause is this, and what does κά contribute?",
    answer:"ὥστε + INDICATIVE, stating an actual result rather than a natural or intended one — and the negative οὐ (not μή) confirms it, since a ὥστε clause with the infinitive would take μή. κά is Doric ἄν, and with the past indicative ἐδυνάθην it makes the potential of the past: 'I could not have'.",
    why:"ὥστε splits two ways and the mood tells you which: with the infinitive it gives the tendency or natural consequence ('so as to'), with a finite verb the actual outcome ('so that in fact'). The negative is a free extra clue — μή with the infinitive, οὐ with the indicative — so you can often identify the construction before you reach the verb. Then ἄν/κα with a past indicative is the standard way of saying 'would have', the apodosis of an unreal condition or, as here, a bare potential of the past. ἐδυνάθην is Doric ᾱ for η, and another of the -θην aorists that are passive in form but middle in meaning, like ἠράσθην at 25." },

  { id:"theoc11-19-81:s31:q1", readingId:"theoc11-19-81", seg:31, type:"morphology",
    prompt:"νῦν μάν, ὦ κόριον, νῦν αὐτίκα νεῖν γε μαθεῦμαι. Parse μαθεῦμαι, and comment on κόριον.",
    answer:"μαθεῦμαι is the Doric contracted FUTURE middle, 1st singular, of μανθάνω = Attic μαθήσομαι. κόριον is a DIMINUTIVE of κόρη in -ιον, and therefore neuter regardless of the sex of the person addressed.",
    why:"The Doric contracted future is now a family you should recognize on sight, and it takes several shapes: -εῖς (φυλαξεῖς, διαξεῖς, εὑρησεῖς, δοκησεῖς), -ῶ (ᾀσῶ, φασῶ), and -εῦμαι here, where the -ευ- is the same contraction of -εο- that you met in ἐλέγευ, βατεῦνται, βομβεῦντι and ὁρεῦσα. Attic would show a plain -ησ-. The diminutive is a point about register rather than grammar: diminutives in -ιον are the affectionate vocabulary of everyday speech and comedy, and they are grammatically neuter even for people (παιδίον, γύναιον). The shift from the grand κόρα of 25 and 30 to κόριον here marks a change of tone — he is coaxing now. Dover notes drily that he will need rather more than ordinary swimming to reach Galateia, as he has just admitted at 54f." },

  { id:"theoc11-19-81:s33:q1", readingId:"theoc11-19-81", seg:33, type:"syntax",
    prompt:"ὡς εἰδῶ τί ποχ᾽ ἁδὺ κατοικεῖν τὸν βυθὸν ὕμμιν. Parse εἰδῶ, and identify the subject of the clause it introduces.",
    answer:"εἰδῶ is the subjunctive of οἶδα — a perfect in form but present in meaning, so its subjunctive is a present subjunctive in force. It is in a purpose clause after ὡς. Inside the indirect question, the ARTICLELESS INFINITIVE κατοικεῖν is the subject and ἁδύ the predicate: 'what is sweet about living in the deep'.",
    why:"Three things worth carrying off. οἶδα's whole paradigm is built on a perfect stem while meaning a present, so εἰδῶ, εἰδείην, εἰδέναι all behave as present forms — expect no past sense anywhere in it. An infinitive can serve as the subject of a clause with no article at all (χαλεπὸν τὸ ποιεῖν, or here simply κατοικεῖν), and English has to supply a gerund. And this is the ordinary purpose clause with the subjunctive, to be set against the unreal one at 55 with the past indicative — the same conjunction ὡς, two entirely different constructions in eight lines. Dover glosses ὕμμιν as 'you ⟨Nereids⟩', so the question widens from Galateia to her whole tribe." },

  { id:"theoc11-19-81:s34:q1", readingId:"theoc11-19-81", seg:34, type:"syntax",
    prompt:"ἐξένθοις, Γαλάτεια, καὶ ἐξενθοῖσα λάθοιο … οἴκαδ᾽ ἀπενθεῖν. What mood are ἐξένθοις and λάθοιο, and what does λάθοιο mean?",
    answer:"Both are OPTATIVES OF WISH — no ἄν, main clause, second person: 'may you come out … and may you forget'. λανθάνω in the MIDDLE means 'forget' (the active means 'escape someone's notice'), and here it takes the infinitive ἀπενθεῖν: 'forget to go home'.",
    why:"The optative of wish was the whole architecture of Idyll 1.132–136, and here it returns in a gentler key, running on through ἐθέλοις at 65. The diagnostic is always the same: an optative with ἄν is potential, without it a wish, and in a subordinate clause after a past main verb it is indirect discourse. The voice of λανθάνω is the other lesson, and it belongs with αἱρέω/αἱροῦμαι at 49 — a change of voice changes the dictionary entry outright. Note also the three Doric ν-for-λ forms stacked in two lines: ἐξένθοις, ἐξενθοῖσα, ἀπενθεῖν, all from ἔρχομαι, alongside ἐνθών at 73. And the aorist participle ἐξενθοῖσα is prior to λάθοιο — come out first, then forget." },

  { id:"theoc11-19-81:s35:q1", readingId:"theoc11-19-81", seg:35, type:"syntax",
    prompt:"ποιμαίνειν δ᾽ ἐθέλοις σὺν ἐμὶν ἅμα καὶ γάλ᾽ ἀμέλγειν καὶ τυρὸν πᾶξαι τάμισον δριμεῖαν ἐνεῖσα. Why is ἐνεῖσα nominative rather than accusative?",
    answer:"Because the subject of the infinitives is the same as the subject of the main verb ἐθέλοις — Galateia. A participle agreeing with that subject stays NOMINATIVE, even though it sits among a string of infinitives.",
    why:"This is a rule worth stating flatly: when the subject of an infinitive is identical with the subject of the governing verb, it is not expressed, and any participle or predicate agreeing with it goes into the nominative. Only when the subjects differ do you get an accusative subject and accusative agreements (as with θάλασσαν … ὀρεχθεῖν at 43). Getting it wrong here would make you hunt for a feminine accusative that does not exist. Note also the aspect: ἐνεῖσα is aorist and therefore prior — put the rennet in first, then the cheese sets — while the three infinitives ποιμαίνειν, ἀμέλγειν and πᾶξαι show the present/aorist contrast in the same list, the first two of ongoing activity and the third of the single completed act. And note what the proposal actually is: he is offering her a job in a dairy." },

  { id:"theoc11-19-81:s36:q1", readingId:"theoc11-19-81", seg:36, type:"syntax",
    prompt:"ἁ μάτηρ ἀδικεῖ με μόνα, καὶ μέμφομαι αὐτᾷ. What is the force of μόνα, and why is αὐτᾷ dative?",
    answer:"μόνα is PREDICATIVE with μάτηρ — 'she alone wrongs me', i.e. nobody else is to blame — not attributive 'my only mother'. αὐτᾷ is dative because μέμφομαι governs the dative of the person blamed.",
    why:"Predicative position is signalled by the adjective standing OUTSIDE the article-noun bracket: ἁ μάτηρ … μόνα, not ἁ μόνα μάτηρ. The same test told you πλῆρες was predicative and καλόν attributive at Idyll 1.146, and πράτιστος predicative at 1.77. It matters here because the predicative reading is what carries Dover's point: in his infatuation Polyphemus absolves Galateia entirely and pins the blame on his mother. μέμφομαι joins the group of verbs governing the dative rather than the accusative — with ἐπιτιμάω, ὀργίζομαι, φθονέω, πείθομαι — a list worth memorizing because English gives no clue. Dover adds the social note: since respectable Greek society segregated the sexes, a lover's mother had far more opportunity to speak to his girl than he did, and a well-disposed mother could act as go-between. That is why the failure at 68 is a real grievance." },

  { id:"theoc11-19-81:s38:q1", readingId:"theoc11-19-81", seg:38, type:"syntax",
    prompt:"καὶ ταῦτ᾽ ἆμαρ ἐπ᾽ ἆμαρ ὁρεῦσά με λεπτύνοντα. Explain καὶ ταῦτα, and say what kind of participle each of ὁρεῦσα and λεπτύνοντα is.",
    answer:"καὶ ταῦτα is a fixed idiom, 'and that too, and that although' — it adds an aggravating circumstance. ὁρεῦσα is a CONCESSIVE circumstantial participle agreeing with the mother, 'although she sees'. λεπτύνοντα is a SUPPLEMENTARY participle after the verb of perceiving, agreeing with με: 'sees me growing thin'.",
    why:"Two participles in four words, doing two different jobs — which is exactly the distinction the exam will ask for. A circumstantial participle is a loose modifier and could be dropped without wrecking the sentence; a supplementary participle completes the verb and cannot. Verbs of perceiving, knowing and showing (ὁράω, ἀκούω, οἶδα, φαίνομαι) take the supplementary participle, and that is how Greek says 'see THAT' as against 'see in order to'. You met the same construction with τέτμεν … ἐοῦσαν and εὗρε … σπένδοντας in the Odyssey readings. καὶ ταῦτα is worth learning whole, since parsing it word by word gets you nowhere. And Doric -εῦσα for -ῶσα in ὁρεῦσα belongs with the -ευ- contractions listed under μαθεῦμαι." },

  { id:"theoc11-19-81:s39:q1", readingId:"theoc11-19-81", seg:39, type:"syntax",
    prompt:"φασῶ τὰν κεφαλὰν καὶ τὼς πόδας ἀμφοτέρως μευ σφύσδειν, ὡς ἀνιαθῇ. Identify the construction after φασῶ and parse ἀνιαθῇ.",
    answer:"An accusative-and-infinitive of indirect statement: κεφαλάν and πόδας are subject accusatives and σφύσδειν their infinitive — 'I shall say that my head and both my feet are throbbing'. ἀνιαθῇ is aorist passive subjunctive 3rd singular in a purpose clause after ὡς.",
    why:"Verbs of saying and thinking take acc. + inf., and the accusatives belong to the infinitive rather than to the main verb — the same trap as at line 5 (γινώσκειν … τυ) and Idyll 1.102 (φράσδη … ἅλιον δεδύκειν). Here two subject accusatives share one infinitive. The purpose clause is the third ὡς-construction in this poem and the second with the subjunctive; set all three side by side (55 indicative, 62 subjunctive, 71 subjunctive) and the pattern is clear. Note the -θη- of the aorist passive lengthening to -θῇ in the subjunctive. And notice the rhetoric: ἀνιαθῇ and ἀνιῶμαι are the same verb in the same voice, put a few words apart to make the revenge exact — let her suffer because I suffer." },

  { id:"theoc11-19-81:s40:q1", readingId:"theoc11-19-81", seg:40, type:"syntax",
    prompt:"ὦ Κύκλωψ Κύκλωψ, πᾷ τὰς φρένας ἐκπεπότασαι; Parse ἐκπεπότασαι, and account for τὰς φρένας.",
    answer:"Perfect middle/passive indicative 2nd singular of ἐκποτάομαι, a PERFECT OF STATE: 'you have flown off and are still gone'. τὰς φρένας is an ACCUSATIVE OF RESPECT — literally 'you have flown away as to your wits', i.e. you are out of your mind.",
    why:"The accusative of respect for the third time in this poem (ψυχάν and ὀφθαλμόν at 52–53) and after two instances in Idyll 1 — by now it should be automatic: an accusative beside a verb that cannot take an object names the part or aspect in which the statement holds. What makes this one striking is that the SUBJECT has done the flying and the wits are only the respect in which — English has to invert it. The perfect of state joins πέφυκα (1), τέταται (32) and ἕστηκα-type verbs generally. Dover points to the wider gesture: self-address by name at a moment of crisis is a recognizable move, used by Medea at Euripides, Medea 401f. and by Demeas in Menander's Samia — the mark of a character trying to take himself in hand. It is the turning-point of the song." },

  { id:"theoc11-19-81:s41:q1", readingId:"theoc11-19-81", seg:41, type:"syntax",
    prompt:"αἴ κ᾽ ἐνθὼν ταλάρως τε πλέκοις καὶ θαλλὸν ἀμάσας ταῖς ἄρνεσσι φέροις, τάχα κα πολὺ μᾶλλον ἔχοις νῶν. Describe the conditional, and translate ἐνθών idiomatically.",
    answer:"A future-less-vivid ('should–would') condition: αἰ (= εἰ) with κα and the optatives πλέκοις and φέροις in the protasis, and τάχα κα with the optative ἔχοις in the apodosis. Dover: ἐνθών is 'go and …', i.e. from here — the participle of motion that English turns into a coordinate verb.",
    why:"The condition is worth laying out because Doric disguises it: αἴ κα normally introduces a prospective protasis with the SUBJUNCTIVE (as at 61, ἀφίκηται), but here the verbs are optative, giving the remoter 'should you …, you would …'. So read the mood, not the particle. The κα appears twice, once in each half, which is unusual and helpful. Then the participle: Greek subordinates the going and leaves the main verb finite, where English coordinates — 'go and plait', not 'having gone, you would plait'. Compare ἀμάσας, aorist and therefore prior: cut the greenery first, then carry it. And νῶν is Doric for νοῦν, with -οο- contracting to -ω rather than -ου — 'you would have a great deal more sense' is exactly the English idiom." },

  { id:"theoc11-19-81:s43:q1", readingId:"theoc11-19-81", seg:43, type:"syntax",
    prompt:"τὰν παρεοῖσαν ἄμελγε· τί τὸν φεύγοντα διώκεις; The first participle is feminine and the second masculine, though both refer to Galateia. Why?",
    answer:"τὰν παρεοῖσαν is feminine because Dover would supply ὄϊν or αἶγα — 'milk the ewe that is there', a farmyard metaphor. τὸν φεύγοντα is MASCULINE because the utterance has turned generalizing: 'the one who runs away', anybody. A proverb has no gender.",
    why:"This is a good test of whether you are reading the Greek or the story. Greek uses the masculine as the unmarked gender for general statements, so a masculine participle need not have a male referent — compare τὸν φιλέοντα at 19, which Dover says is 'one who loves you' rather than 'me who love you'. When the gender of a participle does not match the person you expect, ask whether the sentence has gone proverbial. The article-plus-participle construction is doing the work in both halves: an attributive phrase with the noun suppressed, which is how Greek makes 'the one who…'. The pairing φεύγω/διώκω is a commonplace of erotic poetry from Sappho onwards, and the advice is the oldest in the world — take the one who is available." },

  { id:"theoc11-19-81:s44:q1", readingId:"theoc11-19-81", seg:44, type:"syntax",
    prompt:"κιχλίζοντι δὲ πᾶσαι, ἐπεί κ᾽ αὐταῖς ὑπακούσω. Parse κιχλίζοντι and ὑπακούσω, and account for αὐταῖς.",
    answer:"κιχλίζοντι is present active indicative 3rd PLURAL, Doric -ντι for Attic -ουσι. ὑπακούσω is aorist SUBJUNCTIVE, not future indicative — the κ᾽ (= κα = ἄν) with ἐπεί makes an indefinite temporal clause, ἐπειδάν. αὐταῖς is dative because verbs of listening and obeying govern the dative.",
    why:"The two identical-looking forms are the point. -σω is both future indicative and aorist subjunctive for a sigmatic verb, and only the particle tells you which — exactly the problem posed by σπείσω at Idyll 1.144. Train yourself to check for ἄν/κα and a subordinating conjunction before you decide. κιχλίζοντι is a different trap: -ντι looks like a participle dative singular but is the Doric 3rd plural, as in γελᾶντι, βομβεῦντι and ἐντί. And ὑπακούω joins the dative-taking verbs alongside μέμφομαι at 67. Dover reads the human situation sharply: the girls giggle, as well they might, when Polyphemus takes their teasing seriously — and he knows they are teasing, but tries at 79 to tell himself otherwise." },

  { id:"theoc11-19-81:s45:q1", readingId:"theoc11-19-81", seg:45, type:"syntax",
    prompt:"δῆλον ὅτ᾽ ἐν τᾷ γᾷ κἠγών τις φαίνομαι ἦμεν. Parse φαίνομαι with ἦμεν, and explain τις.",
    answer:"φαίνομαι is used PERSONALLY with an infinitive — 'I appear to be' — so the complement τις is nominative, agreeing with the subject, and ἦμεν is the Doric infinitive of εἰμί. Dover: τις here is like the English 'I'm SOMEBODY', i.e. a person of consequence.",
    why:"φαίνομαι splits by construction: with an infinitive it means 'seem, appear (but perhaps am not)', with a participle 'am plainly, evidently am'. The difference is real and often decisive — and here the infinitive is exactly right, since the whole line is self-persuasion rather than fact. It works like δοκέω at 50, personal construction giving a nominative complement. The indefinite τις used absolutely for 'somebody important' is an idiom worth collecting; Dover notes it differs from the τις of Idyll 1.85 (which softened an adjective) and compares Euripides. And ἦμεν is the Doric infinitive for the second time in the poem, still looking like a 1st plural imperfect and still identifiable only from the construction." },

  { id:"theoc11-19-81:s47:q1", readingId:"theoc11-19-81", seg:47, type:"syntax",
    prompt:"οὕτω τοι Πολύφαμος ἐποίμαινεν τὸν ἔρωτα μουσίσδων, ῥᾷον δὲ διᾶγ᾽ ἢ εἰ χρυσὸν ἔδωκεν. What is the force of ἐποίμαινεν, of μουσίσδων, and of ἢ εἰ?",
    answer:"ἐποίμαινεν is a METAPHOR — 'shepherded' his love, i.e. managed it as one manages livestock — and imperfect for the long process. μουσίσδων is an instrumental participle giving the means, 'by making music'. ἢ εἰ is an elliptical comparison after the comparative ῥᾷον: 'more easily than (he would have) if he had paid gold'.",
    why:"The closing couplet is built to answer the opening. ῥᾷον picks up ῥάιστα at 7 and οὐ ῥᾴδιον at 4 — positive, superlative and comparative of one word mapping the whole argument. μουσίσδων is formed straight on Μοῦσα, so it answers ἢ ταὶ Πιερίδες at 3: the remedy was the Muses all along. διᾶγ(ε) repeats line 7 verbatim, closing the ring. And χρυσόν is the last word of the argument for a reason — Nikias is a doctor, and the point of the whole verse-letter is that song is the cheaper prescription. On the grammar, note that a participle with no article and no connective very often gives the MEANS, and that a comparative should always send you looking for its second term, whether that is a genitive (as four times over at 20–21) or ἤ with a whole clause, as here." },
];
